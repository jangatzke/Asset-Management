-- Idempotent runtime alignment for reminder automation tables.
-- Apply to drifted local/live databases if Prisma migration history is not deployable:
--   npx prisma db execute --file prisma/reminder-runtime-alignment.sql --schema prisma/schema.prisma
